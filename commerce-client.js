(function () {
  ...
  const reasons = {
    ...
    'insufficient-gold': '연구 골드가 부족합니다. 전투 보상으로 얻을 수 있습니다.',
    'tree-system': '다이스 트리로 개편된 기능입니다. 게임을 새로고침한 뒤 연구 메뉴를 이용해 주세요.',
    'prerequisite': '연결된 이전 주사위를 먼저 해금해 주세요.', 'max-mastery': '최대 숙련에 도달했습니다.',
    'mastery-required': '필요한 숙련을 먼저 달성해 주세요.', 'invalid-talent': '집중 또는 통찰 중 하나를 선택해 주세요.',
    'already-awakened': '이미 각성 연구를 마쳤습니다.', 'invalid-supporter': '사용할 서포터를 다시 선택해 주세요.',
