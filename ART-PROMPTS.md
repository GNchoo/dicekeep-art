...
> **7~20성 현행 자산**: 아래의 2026-09-02 가챠 타워 브리프는 과거 작업 기록이다. 게임은 현재 풀 없는 간결한 `casual/towers/star-NN-casual.png` 14종을 사용한다. 제작·승격·비교 자료는 `tools/art-review/star-casual-2026-09-23/README.md`에 있다.
