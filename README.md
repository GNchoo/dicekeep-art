...
현재 투기장은 **순수운빨(101·성장 미적용)**, **덱빌드(101·편성 5종·Lv20)**, **극한(무한·Lv200)**으로 나뉜다. 모든 모드에서 무료 성장 조각을 얻는다. [규칙·보상·성능 측정](docs/MODES-AND-PERFORMANCE.md)에 상세 조건과 검증 방법이 있다. [개발 진행](docs/DEVELOPMENT-STATUS.md)과 [외형·소액 성장 상품](docs/BUSINESS-MODEL.md)에 최신 변경과 출시 조건을 기록한다.
